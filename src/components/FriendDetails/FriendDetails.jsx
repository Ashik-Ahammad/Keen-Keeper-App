    ...
    <div className="px-4 sm:px-6 md:p-6 mt-6 md:mt-10 min-h-screen w-full max-w-5xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow p-6 text-center">
          ...
          <p className="text-gray-400 mt-3 text-sm sm:text-base wrap-break-word">{friend.email}</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white rounded-xl shadow p-4 text-center">
              ...
              <p className="text-gray-500 text-sm md:text-base">Days Since Contact</p>
            </div>
          ...
          <div className="bg-white rounded-xl shadow p-5 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 text-center sm:text-left">
            <div>
              ...
              <p className="text-gray-500 text-sm sm:text-base">Connect every {friend.goal} days</p>
            </div>
          ...
          <div className="bg-white rounded-xl shadow p-5">
            <h3 className="font-semibold text-lg mb-4 text-center sm:text-left">Quick Check-In</h3>

            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              <button
                onClick={handleCall}
                className="border p-3 sm:p-4 border-gray-100 shadow-sm rounded-lg hover:bg-gray-50 transition-colors hover:cursor-pointer flex flex-col items-center justify-center gap-2"
              >
